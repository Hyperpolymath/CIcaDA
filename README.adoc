...
:experimental:
:url-github: https://github.com/hyperpolymath/CIcaDA
:url-gitlab: https://gitlab.com/hyperpolymath/CIcaDA
:url-bitbucket: https://bitbucket.org/hyperpolymath/CIcaDA
:url-codeberg: https://codeberg.org/hyperpolymath/CIcaDA

Continuous Integration cycle analysis and debugging assistant
...
CIcaDA is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
